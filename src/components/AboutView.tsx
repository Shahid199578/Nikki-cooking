    ...
    <div className="space-y-20 pb-20 animate-fadeIn">
      ...
      <section className="relative py-16 md:py-24 bg-[#FDFBF7] overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 md:px-16 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            <span className="text-xs uppercase font-semibold text-[#D97706] tracking-widest mb-3 block">
              Meet Nikki
            </span>
            ...
            <p className="text-[#83746B] text-base md:text-lg leading-relaxed mb-8">
            ...
            <div className="flex flex-wrap gap-4">
              <button
                ...
                className="bg-[#D97706] text-white px-6 py-3.5 rounded-xl font-bold text-xs uppercase tracking-widest hover:bg-opacity-90 transition-all shadow-sm cursor-pointer"
              >
                Explore Workshops
              </button>
              <button
                onClick={onContactClick}
                className="border border-[#83746B]/30 text-[#5D4037] px-6 py-3.5 rounded-xl font-semibold text-xs uppercase tracking-widest hover:bg-[#F3EDE6] transition-all cursor-pointer"
              >
                Contact Studio
              </button>
            </div>
          ...
          <div className="relative group">
            <div className="absolute -inset-4 bg-[#F3EDE6] rounded-2xl rotate-2 -z-10 transition-transform group-hover:rotate-1" />
            <div className="aspect-[4/5] w-full rounded-2xl overflow-hidden shadow-lg border border-[#83746B]/10">
              <img
      ...
      <section className="py-12 px-6 md:px-16 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          {/* Science of Baking */}
          <div className="md:col-span-7 bg-[#F3EDE6] p-8 sm:p-12 rounded-2xl border border-[#83746B]/10 flex flex-col justify-center min-h-[380px]">
            <span className="material-symbols-outlined text-[#D97706] text-4xl mb-4">science</span>
            <h2 className="font-serif text-3xl text-[#5D4037] font-bold mb-4">
              The Science of Baking
            </h2>
            <p className="text-[#83746B] text-base leading-relaxed mb-6">
            ...
            <div className="flex flex-wrap gap-2">
              <span className="bg-[#FDFBF7] px-4 py-1.5 rounded-full text-xs font-semibold text-[#D97706]">
                HYDRATION
              </span>
              <span className="bg-[#FDFBF7] px-4 py-1.5 rounded-full text-xs font-semibold text-[#D97706]">
                FERMENTATION
          ...
          {/* Scoring Image */}
          <div className="md:col-span-5 rounded-2xl overflow-hidden min-h-[380px] shadow-sm border border-[#83746B]/10">
            <img
          ...
          <div className="md:col-span-7 bg-[#5D4037] text-[#F3EDE6] p-8 sm:p-12 rounded-2xl border border-[#D97706]/20 flex flex-col justify-center min-h-[380px]">
            <h2 className="font-serif text-3xl text-[#D97706] font-bold mb-4">
              Authentic Heritage
            </h2>
            <p className="text-[#F3EDE6]/90 text-base leading-relaxed">
      ...
      {/* Timeline Section */}
      <section className="py-16 bg-[#FDFBF7] px-6 md:px-16 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="font-serif text-4xl text-[#5D4037] font-bold mb-3">
            A Decade of Teaching
          </h2>
          <p className="text-[#83746B] max-w-xl mx-auto text-sm md:text-base">
        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          <div className="hidden md:block absolute left-1/2 transform -translate-x-1/2 w-0.5 h-full bg-[#83746B]/20" />

          <div className="space-y-12">
            {/* 2014 */}
            <div className="relative flex flex-col md:flex-row items-center justify-between">
              <div className="md:w-5/12 text-center md:text-right order-2 md:order-1 mt-4 md:mt-0">
                <h3 className="font-serif text-2xl font-bold text-[#D97706] mb-2">2014</h3>
              ...
              <div className="z-10 bg-[#D97706] w-5 h-5 rounded-full border-4 border-white shadow-md order-1 md:order-2" />
            ...
            <div className="relative flex flex-col md:flex-row items-center justify-between">
              ...
              <div className="z-10 bg-[#D97706] w-5 h-5 rounded-full border-4 border-white shadow-md order-2" />
              <div className="md:w-5/12 text-center md:text-left order-3 mt-4 md:mt-0">
                <h3 className="font-serif text-2xl font-bold text-[#D97706] mb-2">2017</h3>
                <p className="text-[#83746B] text-sm leading-relaxed">
            ...
            <div className="relative flex flex-col md:flex-row items-center justify-between">
              <div className="md:w-5/12 text-center md:text-right order-2 md:order-1 mt-4 md:mt-0">
                <h3 className="font-serif text-2xl font-bold text-[#D97706] mb-2">2021</h3>
                <p className="text-[#83746B] text-sm leading-relaxed">
      ...
      <section className="px-6 md:px-16 max-w-5xl mx-auto">
        <div className="bg-[#5D4037] p-10 md:p-16 rounded-3xl text-center text-white relative overflow-hidden shadow-2xl">
          <div className="relative z-10">
            <h2 className="font-serif text-3xl sm:text-4xl font-bold mb-4">
              Begin Your Own Journey
            </h2>
            <p className="text-sm sm:text-base text-[#F3EDE6]/80 max-w-lg mx-auto mb-8">
              Join a community where every loaf is a lesson and every student is a master in the making.
            </p>
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <button
                onClick={onExploreClasses}
                className="bg-[#D97706] text-[#5D4037] px-8 py-3.5 rounded-xl font-bold text-xs uppercase tracking-wider hover:bg-white transition-all shadow-md cursor-pointer"
              >
                Explore Classes
              </button>
              <button
