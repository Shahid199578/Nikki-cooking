    ...
    <>
      ...
      <section className="py-20 px-6 md:px-16 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <h2 className="font-serif text-3xl md:text-4xl text-[#3E2723] font-bold mb-4">
            Why Learn with Nikki?
          </h2>
          <p className="text-[#77574d] max-w-2xl mx-auto text-base">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <div className="md:col-span-2 bg-[#F2E8D5] rounded-2xl p-8 border border-[#77574d]/10 flex flex-col justify-between group cursor-pointer transition-all hover:shadow-lg">
            <div>
              <div className="bg-white w-12 h-12 rounded-xl flex items-center justify-center text-[#8d4b00] mb-6 shadow-xs">
                <span className="material-symbols-outlined text-2xl">auto_awesome</span>
              </div>
              <h3 className="font-serif text-2xl text-[#3E2723] font-bold mb-3">
                Professional Techniques
              </h3>
              <p className="text-[#77574d] text-sm md:text-base mb-8 leading-relaxed">
                Master the same methods used in high-end boulangeries, adapted for your home oven and environment.
              </p>
            </div>
            <div className="h-48 overflow-hidden rounded-xl border border-[#77574d]/10">
              <img
          ...
          <div className="bg-[#F9F6F0] rounded-2xl p-8 border border-[#77574d]/10 transition-all hover:shadow-lg flex flex-col items-center text-center justify-center">
            <div className="bg-[#8d4b00]/10 w-16 h-16 rounded-full flex items-center justify-center text-[#8d4b00] mb-6">
              <span className="material-symbols-outlined text-3xl">groups</span>
            </div>
            <h3 className="font-serif text-xl md:text-2xl text-[#3E2723] font-bold mb-3">
          ...
          <div className="bg-white rounded-2xl p-8 border border-[#77574d]/10 transition-all hover:shadow-lg flex flex-col justify-end relative overflow-hidden group min-h-[260px]">
            ...
            <div className="relative z-10 bg-white/80 backdrop-blur-xs p-4 rounded-xl border border-[#77574d]/10">
              <h3 className="font-serif text-xl text-[#3E2723] font-bold mb-2">
                Premium Ingredients
              </h3>
              <p className="text-[#77574d] text-xs leading-relaxed">
          ...
          <div
            ...
            className="md:col-span-2 bg-[#3E2723] text-white rounded-2xl p-8 flex items-center gap-8 relative overflow-hidden group cursor-pointer shadow-md hover:shadow-xl transition-all"
          >
            <div className="flex-1 z-10">
              ...
              <p className="text-[#F2E8D5]/80 text-sm mb-6 leading-relaxed">
                Complete our intensive 4-week bakery fundamental series and earn your Home-Style Bakery Certification.
              </p>
              <span className="inline-flex items-center gap-2 text-[#F59E0B] font-bold text-xs uppercase tracking-wider group-hover:translate-x-1 transition-transform">
          ...
          {/* Card 5: Meet Nikki */}
          <div className="md:col-span-2 bg-white rounded-2xl p-2 border border-[#77574d]/10 flex flex-col md:flex-row items-center overflow-hidden shadow-xs">
            ...
            <div className="w-full md:w-1/2 p-6 flex flex-col justify-center">
              ...
              <p className="text-[#77574d] text-sm italic mb-6 leading-relaxed">
                "Baking is a conversation between the grain, the water, and your hands. I'm here to help you understand that dialogue."
              </p>
              <button
                onClick={onReadStory}
                className="text-[#8d4b00] font-bold text-xs uppercase tracking-wider flex items-center gap-1 hover:translate-x-1 transition-transform cursor-pointer"
              >
      ...
      <section className="py-20 bg-[#fff1e9] border-y border-[#77574d]/10">
        <div className="px-6 md:px-16 max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12">
          <div className="flex-1">
            ...
            <p className="text-[#77574d] text-base mb-8 max-w-md leading-relaxed">
            ...
            {subscribed ? (
              ...
              <form onSubmit={handleSubscribe} className="flex flex-col sm:flex-row gap-3 max-w-md">
                <input
                  ...
                  className="flex-1 bg-[#F9F6F0] border border-[#77574d]/20 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-[#8d4b00]"
                />
                <button
                  type="submit"
                  className="bg-[#3E2723] text-white px-8 py-3 rounded-xl font-bold text-xs uppercase tracking-wider hover:bg-opacity-95 transition-all cursor-pointer whitespace-nowrap"
                >
                  Subscribe
                </button>
              </form>
          ...
          <div className="flex-1 grid grid-cols-2 gap-4">
            <div className="aspect-square rounded-2xl overflow-hidden shadow-md hover:-translate-y-1 transition-transform border border-[#77574d]/10">
              <img
            ...
            <div className="aspect-square rounded-2xl overflow-hidden shadow-md translate-y-6 hover:translate-y-5 transition-transform border border-[#77574d]/10">
              <img
